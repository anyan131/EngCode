...
public class BatteryLog extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * mLogRecord = (Button) findViewById(R.id.Log_Record); if(mLogRecord ==
		 * null) { Log.e(TAG, "clocwork worked..."); //not return and let
		 * exception happened. } mLogRecord.setOnClickListener(this);
		 */
