    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_A:
                buttonEnableCheck(keyCode, R.string.key_A);
                return true;
            case KeyEvent.KEYCODE_B:
                buttonEnableCheck(keyCode, R.string.key_B);
                return true;
            case KeyEvent.KEYCODE_C:
                buttonEnableCheck(keyCode, R.string.key_C);
                return true;
            case KeyEvent.KEYCODE_D:
                buttonEnableCheck(keyCode, R.string.key_D);
                return true;
            default:
                return false;
        }
