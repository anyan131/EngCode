...
public class FmAlexTaoActivity extends Activity {
...
//                }
                ...
                case R.id.FMR_Freq_tune:
                    ...
                    try {
                        ...
                        if (!FmRadioUtils.isValidStation(station)) {
                            Toast.makeText(FmAlexTaoActivity.this, "Please input 87.5 ~ 108.0.", Toast.LENGTH_SHORT).show();
                            mEditFreq.setText(FmRadioUtils.formatStation(mCurrentStation));
                            return;
                        }
                    } catch (NumberFormatException e) {
                        Toast.makeText(FmAlexTaoActivity.this, "bad float format.", Toast.LENGTH_SHORT).show();
                        mEditFreq.setText(FmRadioUtils.formatStation(mCurrentStation));
                        return;
                    }
                ...
                case R.id.FMR_EM_RSSI_THRESHOLD_OK:
                    ...
                    try {
                        ...
                        Toast.makeText(FmAlexTaoActivity.this, "bad format.", Toast.LENGTH_SHORT).show();
                        mEditFreq.setText("0");
                        return;
                    }
                    ...
                    if (isRssiOk) {
                        Toast.makeText(FmAlexTaoActivity.this, "Rssi Threshold set OK.", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(FmAlexTaoActivity.this, "Rssi Threshold set fail.", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case R.id.FMR_EM_DESENSE_RSSI_OK:
                    ...
                    if (isDeRssiOk) {
                        Toast.makeText(FmAlexTaoActivity.this, "Desense Rssi Threshold set OK.", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(FmAlexTaoActivity.this, "Desense Rssi Threshold set fail.", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case R.id.FMR_EM_MUTE_GAIN_OK:
                    ...
                    if (isMuteOk) {
                        Toast.makeText(FmAlexTaoActivity.this, "Software mute gain set OK.", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(FmAlexTaoActivity.this, "Software mute gain set fail.", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case R.id.FMR_EM_CMD_OK:
                    ...
                    if (cmds == null) {
                        Toast.makeText(FmAlexTaoActivity.this, "cmd execute fail.", Toast.LENGTH_SHORT).show();
                    ...
                    break;
                case R.id.fm_alex_pass:
                    setResult(10);
                    finish();
                    break;

                case R.id.fm_alex_fail:
                    setResult(20);
                    finish();
                    break;
                default:
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "begin FmAlexTaoActivity.onCreate");
        ...
        Button passbtn = (Button) findViewById(R.id.fm_alex_pass);
        Button failbtn = (Button) findViewById(R.id.fm_alex_fail);
...
//        ComponentName cn = startService(new Intent(FmAlexTaoActivity.this, FmRadioService.class));
//        if (null == cn) {
//            Log.e(TAG, "Error: Cannot start FM service");
//        } else {
//            Log.d(TAG, "Start FM service successfully.");
//            mIsServiceStarted = true;
        /*mIsServiceBinded = bindService(new Intent(FmAlexTaoActivity.this, FmRadioService.class), mServiceConnection,
...
//        }
        ...
        mCurrentStation = 1043;
        mAudioManager = (AudioManager) getSystemService(Context.AUDIO_SERVICE);
        refreshTextStatus(mIsPlaying);
        Log.d(TAG, "end FmAlexTaoActivity.onCreate");
    }

    //alextao modified here
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            Log.d(TAG, "begin FmAlexTaoActivity.onServiceConnected");
            ...
            Log.d(TAG, "<<< FmAlexTaoActivity.onServiceConnected");
        }

        public void onServiceDisconnected(ComponentName className) {
            Log.d(TAG, ">>> FmAlexTaoActivity.onServiceDisconnected");
            mService = null;
            Log.d(TAG, "<<< FmAlexTaoActivity.onServiceDisconnected");
        }
    };
...
//        }
    ...
    public void onDestroy() {
        ...
        Log.d(TAG, ">>> FmAlexTaoActivity.onDestroy");
        mIsDestroying = true;
...
//            powerDown();
    ...
    private void showRDS() {
        Log.v(TAG, "FmAlexTaoActivity.showRDS PS : " + mPSString + "RT :" + mLRTextString);
...
//        return false;
     ...
     * switch antenna
     *
     * @param type antenna (0, long antenna, 1 short antenna)
